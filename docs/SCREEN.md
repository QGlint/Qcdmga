...
>教室的屏幕可以使用HDMI连接自己的能连HDMI的设备，以下大部分无线场景对接收端有性能要求，因此推荐使用自己的电脑做接收端并将电脑连接到大屏幕上，使用教室电脑使用线上的会议方案问题不大，因为腾讯等本来就把视频压缩成一坨了，有线方案也问题不大，主要是无线方案，学校电脑有线网段和学校无线网隔了一层NAT，不一定能建立网络联系。
